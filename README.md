...
| Name | Type <div style="width: 200px"></div> | Required | Description |
| ---- | ---- | ---- | ----------- |
| fields | _[<br/>&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;value: any<br>&nbsp;&nbsp;&nbsp;&nbsp;validate: (any) => boolean<br>&nbsp;&nbsp;},<br/>&nbsp;&nbsp;...<br />]_ | yes | Form field's data (each field must have `value`  and `validate` properties - other properties are not important) |
