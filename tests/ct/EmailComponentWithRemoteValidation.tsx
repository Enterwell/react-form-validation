...
const EmailComponentWithRemoteValidation = (props: { email: string }) => {
    const emailValidation = (value: unknown) => new Promise<boolean>((resolve) => setTimeout(() => resolve(isValidEmail(value)), 2000));
